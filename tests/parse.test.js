const customizedJSON = require('../src/parse')
...
describe('Replace string value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'string') { return 'Hello World!' } else { return originalValue } })
...
describe('Replace false boolean value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'boolean') { return true } else { return originalValue } })
...
describe('Replace true boolean value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'boolean') { return newValue } else { return originalValue } })
...
describe('Replace numeric value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'number') { return 222 } else { return originalValue } })
...
describe('Replace negative numeric value by positive value', () => {
  it('returns the expected JSON object', () => {
    const jsonString = '{"mykey": -100}'
    const newValue = 2
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'number') { return newValue } else { return originalValue } })
    expect(parsedJSON).toEqual({ mykey: newValue })
  })
})
...
describe('Replace string value by null', () => {
  it('returns the expected JSON object', () => {
    const jsonString = '{"mykey": "myvalue"}'
    const newValue = null
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'string') { return newValue } else { return originalValue } })
    expect(parsedJSON).toEqual({ mykey: newValue })
  })
})
...
describe('Replace null value by String', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (originalValue === null) { return newValue } else { return originalValue } })
    expect(parsedJSON).toEqual({ mykey: newValue })
  })
})
...
describe('Replace an object by a new object', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'object') { return newValue } else { return originalValue } })
...
describe('Replace an object and its contained value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'object') { return newObjectValue } else if (typeof originalValue === 'string') { return newStringValue } else { return originalValue } })
...
describe('Replace string value of property "mykey" if parent is "parentKey"', () => {
  it('returns the expected JSON object', () => {
    ...
    const newValue = 'newValue'
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'string' && parentKeys.toString() === 'parentKey,mykey') { return newValue } else { return originalValue } })
...
describe('Replace an array and its contained value', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (Array.isArray(originalValue)) { return newArrayValue } else if (typeof originalValue === 'string') { return newStringValue } else { return originalValue } })
...
describe('Replace a specific array value', () => {
  it('returns the expected JSON object', () => {
    const jsonString = '{"mykey": ["first", "second", "third"]}'
    const newValue = 'newValue'
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'string' && parentKeys.toString() === 'mykey,1') { return newValue } else { return originalValue } })
...
describe('Replace Big Number value by its proper string representation', () => {
  it('returns the expected JSON object', () => {
    ...
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => { if (typeof originalValue === 'number' && originalValue.toString() !== stringValue) { return stringValue } else { return originalValue } })
...
describe('Use default JSON reviver function for customizing a JSON Object.', () => {
  it('returns the expected JSON object', () => {
    const jsonString = '{"mykey": "myvalue"}'
    const newValue = 'newValue'
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue) => { if (key === 'mykey') { return newValue } else { return originalValue } })
    expect(parsedJSON).toEqual({ mykey: newValue })
  })
})
...
describe('Replace value if sibling has key "otherKey"', () => {
  it('returns the expected JSON object', () => {
    ...
    const newValue = true
    const parsedJSON = customizedJSON.parse(jsonString, (key, originalValue, stringValue, jsonObject, parentKeys) => {
...
describe('Parse an invalid JSON Object', () => {
  it('does not parse the object but throws the expected exception as an invalid object has been passed as argument', () => {
    const jsonString = '{mykey: "myvalue"}'
    expect(() => customizedJSON.parse(jsonString)).toThrowError('Unexpected token m in JSON at position 1')
  })
})
